...
st.error("Oops you run into the error, you neend to rerun your app and install your app again")
...
values=st.slider("Selct a range of values",0,200,(15,80))
...
add_sidebar=st.sidebar.selectbox("What is your favourite course?",("A course from TDS on building Data Web App","Others","An not sure"))
